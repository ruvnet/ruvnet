...
> Reviewed changes: `node plugins/ruvnet/bin/ruvnet.mjs search 5 raw retrieval ranking` · exact-token evidence with auditable matched terms · [Harness evidence](https://ruvnet-harness-evidence.ruv.chatgpt.site)
