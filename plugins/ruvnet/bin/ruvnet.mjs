...
async function main(args) {
  ...
  else if (command === 'changes' && rest.length <= 4) {
    const limit = rest.length ? Number(rest[0]) : 10;
    result = changes(limit, Date.now(), { ...(rest[1] === undefined ? {} : { project: rest[1] }), ...(rest[2] === undefined ? {} : { kind: rest[2] }) }, rest[3]);
  }
