...
**At least 751 published artifacts across four public registries** — **398** Rust crates (1,267,973 cumulative downloads), **361** npm packages maintained by `ruvnet`, **8** ownership-verified PyPI libraries, and **22** Hugging Face models and spaces across the `ruvnet` and `ruv` accounts.
...
*Live registry counts were verified July 11, 2026 ET / July 12 UTC from the official npm and crates.io APIs. The exact npm recount is **64,198,893 downloads** across 369 maintained packages for the complete 365-day window **2025-08-10 through 2026-08-09**. The older **34,447,577** figure is retained only as the June 13 historical snapshot. crates.io reports **1,267,973 cumulative downloads** across 398 crates. npm and crates.io counts include target-specific platform packages; registry ownership or maintainer status proves control of the publication surface, not sole authorship.*

## Registry totals

| Registry | Packages | Downloads |
|---|---|---|
| [crates.io](https://crates.io/users/ruvnet) | **398** | 1,267,973 cumulative |
| [npm](https://www.npmjs.com/~ruvnet) | **369** | **64,198,893** during 2025-08-10–2026-08-09 |
